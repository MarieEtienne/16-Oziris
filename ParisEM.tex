...
\end{subfigure}
\caption{\textit{Left: }Distribution of the empirical absolute relative bias (given in equation \eqref{eq:emp:bias}) for each method in the case of the SINE model. \textit{Right: }Distribution of the empirical absolute coefficient of variation (given in equation \eqref{eq:emp:cv}) for each method for the SINE model.These distributions are obtained using 100 replications of the experience showed on Figure \ref{fig:res:SINE}. All estimations are performed in a similar computation time.}
\label{fig:mult:SINE}
\end{figure}
\begin{figure}[p]
\centering
...
\end{subfigure}
\caption{\textit{Left: }Distribution of the empirical absolute relative bias (given in equation \eqref{eq:emp:bias}) for each method in the case of the Log-growth model. \textit{Right: }Distribution of the empirical absolute coefficient of variation (given in equation \eqref{eq:emp:cv}) for each method for the Log-growth model.These distributions are obtained using 100 replications of the experience showed on Figure \ref{fig:res:LG}. All estimations are performed in a similar computation time.}
\label{fig:mult:LG}
\end{figure}
\section{Conclusions}
