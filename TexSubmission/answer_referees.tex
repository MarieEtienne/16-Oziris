...
The numerical section now contains a complete implementation of the EM algorithm which highlights clearly \textcolor{red}{BIM} the performance of the proposed PaRIS algorithm.  
\end{enumerate}
