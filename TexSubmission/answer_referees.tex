...
\textcolor{red}{Je propose de ne pas mettre de resultat analytique pour ne pas alourdir la chose (surtout que c'est tres dependant du modele et du GPE utilise). On peut par contre donner quelques resultats numeriques, tu as garde les couts de calcul Pierre ?}
